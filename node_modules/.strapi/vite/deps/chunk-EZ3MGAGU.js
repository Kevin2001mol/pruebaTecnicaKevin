...
import {
  ...
  useGetReleasesQuery
} from "./chunk-CGKKF6JY.js";
import {
  buildValidParams as buildValidParams2,
  getStageColorByHex
} from "./chunk-PGV5S76B.js";
import {
...
} from "./chunk-SZUHKHXH.js";
import {
  useTypedSelector
} from "./chunk-E7ZFJOYZ.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-2KVF465W.js";
import {
  useConfig
} from "./chunk-HAC45TZ2.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-6VZBWNIX.js";
import {
  useTracking
} from "./chunk-AWEPTK4E.js";
import {
  useLicenseLimits
} from "./chunk-MNT3UNNN.js";
import {
  Table,
  useTable
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-7RYAI676.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-7GZYVPLB.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-SA3PQAFH.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-GOHE64XL.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-JNPEGN5Y.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-4O4YGWKI.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-XS5K5IVZ.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-KVZO74PJ.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-IOFWUONT.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-LF5XCHDW.js");
          return {
...
//# sourceMappingURL=chunk-EZ3MGAGU.js.map
