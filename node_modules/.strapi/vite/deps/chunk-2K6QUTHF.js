...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-6DLF6XJS.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-C7APFUJ5.js").then((mod) => ({
          default: mod.App
        })),
...
//# sourceMappingURL=chunk-2K6QUTHF.js.map
